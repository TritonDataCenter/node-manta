 ...
 */
function mkBucketReqOpts(path, defaultOpts, userOpts) {
 ...
 *
 * Create and return a stream of buckets objects. This will page through all
...
function createListBucketsStream(opts) {
    ...
    var lastResHeaders;
    var markerFromObj = function markerFromObj(_obj) {
...
// XXX endpoint or some mechanism on ListBucketObjects to just make a single API
// call (as with listing buckets above)
...
/*
 * PutBucketObject (PUT /:login/buckets/:bucketName/objects/:objectName)
 *
